import { Playfair_Display, DM_Sans, DM_Mono, Manrope } from "next/font/google"
import "./globals.css"
...
export default function RootLayout({ children }) {
  return (
    <html lang="en" className={`${playfair.variable} ${dmSans.variable} ${dmMono.variable} ${manrope.variable} bg-[#FAF8F4]`}>
