      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-8">
        ...
        <div className="bg-white border border-black/[0.05] rounded-3xl p-8 shadow-sm">
          <div className="flex items-center gap-3 mb-8">
            <Sparkles className="text-[#2D5A3D]" size={20} />
              ...
              <div key={field.id} className="p-6 rounded-2xl bg-[#FAF8F4] border border-black/[0.03] space-y-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-black/[0.05] rounded-xl px-4 py-2.5 font-playfair text-xl font-bold text-[#1A1814] focus:outline-none focus:border-[#2D5A3D]/40 transition-all"
                    placeholder="40+"
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-black/[0.05] rounded-xl px-4 py-2.5 font-dm-sans text-sm text-[#1A1814] focus:outline-none focus:border-[#2D5A3D]/40 transition-all"
        ...
        <div className="flex justify-end items-center gap-4 pt-8">
          ...
          <button
            ...
            className="bg-[#2D5A3D] text-white px-8 py-4 rounded-2xl flex items-center gap-3 font-dm-sans font-bold text-sm shadow-[0_12px_24px_rgba(45,90,61,0.25)] hover:bg-[#234730] disabled:opacity-50 disabled:shadow-none transition-all active:scale-[0.98]"
          >
            {isLoading ? (
